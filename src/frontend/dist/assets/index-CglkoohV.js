...
function ThemeProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeContext.Provider, { value: { theme: "light", toggleTheme: () => {
  } }, children });
}
class ErrorBoundary extends React$2.Component {
  ...
  render() {
    if (this.state.hasError) {
      return this.props.fallback ?? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "32px 16px", textAlign: "center" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "12px", color: "#6b7280" }, children: "Unable to load this section. Please refresh and try again." })
      ] });
    }
...
function SplashScreen() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[100] flex items-center justify-center bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "img",
    {
      src: SPLASH_IMAGE,
      alt: "Minty",
...
const PackStyleContext = reactExports.createContext({
  activeStyleId: 1,
  activeStyle: PACK_STYLES[1],
  setStyleId: () => {
  }
});
function applyThemeVars(style2) {
  const root2 = document.documentElement;
  const accent = style2.accentOklchLight;
  root2.style.setProperty("--cycle-accent", `oklch(${accent})`);
  root2.style.setProperty("--cycle-accent-oklch", accent);
  root2.style.setProperty("--cycle-accent-r", String(style2.accentR));
  root2.style.setProperty("--cycle-accent-g", String(style2.accentG));
  root2.style.setProperty("--cycle-accent-b", String(style2.accentB));
  root2.style.setProperty(
    "--cycle-accent-rgb",
    `${style2.accentR},${style2.accentG},${style2.accentB}`
  );
  root2.style.setProperty("--cycle-glow-color", style2.glowLight);
  root2.style.setProperty("--accent", accent);
  root2.style.setProperty("--ring", accent);
}
function PackStyleProvider({ children }) {
  const [activeStyleId, setActiveStyleId] = reactExports.useState(() => {
  ...
  const setStyleId = reactExports.useCallback((id) => {
    setActiveStyleId(id);
...
const UserSettingsContext = reactExports.createContext(null);
...
function UserSettingsProvider({
  ...
  const setExplicitModeOn = reactExports.useCallback((on) => {
...
const Track = Record({ "title": Text, "duration": Nat });
const Album = Record({
  "id": Text,
  "coverImageUrl": Text,
  "title": Text,
...
const CreateTcgSetInput = Record({
  "setCode": Text,
  "coverImageUrl": Text,
  "setName": Text,
  "featured": Bool,
...
const MarketListing = Record({
  "seller": Principal2,
  "editionId": Nat,
  "price": Nat
});
const UpdateTcgSetInput = Record({
  "id": Nat,
  "setCode": Text,
  "coverImageUrl": Text,
  "setName": Text,
...
Service({
  ...
  "addAlbum": Func([Album], [], []),
  "addRelease": Func([Release], [], []),
  "assignCallerUserRole": Func([Principal2, UserRole], [], []),
  "createSet": Func([CreateTcgSetInput], [TcgSet], []),
  "deleteSet": Func([Nat], [], []),
  "getAlbumById": Func([Text], [Opt(Album)], ["query"]),
  "getAlbums": Func([], [Vec(Album)], ["query"]),
  "getAllSetsAdmin": Func([], [Vec(TcgSet)], ["query"]),
  "getCallerUserProfile": Func([], [Opt(UserProfile)], ["query"]),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getFeaturedSets": Func([], [Vec(TcgSet)], ["query"]),
  "getMarketListings": Func([], [Vec(MarketListing)], ["query"]),
  "getPokemonSets": Func([], [Vec(TcgSet)], ["query"]),
  "getReleases": Func([], [Vec(Release)], ["query"]),
  "getSetById": Func([Nat], [Opt(TcgSet)], ["query"]),
  "getSetBySlug": Func([Text], [Opt(TcgSet)], ["query"]),
  "getSets": Func([], [Vec(TcgSet)], ["query"]),
  "getUserProfile": Func(
    [Principal2],
    [Opt(UserProfile)],
    ["query"]
  ...
  "searchSetsByName": Func([Text], [Vec(TcgSet)], ["query"]),
  "toggleSetActive": Func([Nat], [], []),
  "updateSet": Func([UpdateTcgSetInput], [TcgSet], [])
});
...
function PetPage() {
  ...
  const [pos, setPos] = reactExports.useState({ x: 140, y: 200 });
  const [dir, setDir] = reactExports.useState(1);
  const [catState, setCatState] = reactExports.useState("walking");
  const [walkFrame, setWalkFrame] = reactExports.useState(0);
  const [tailAngle, setTailAngle] = reactExports.useState(0);
  const [sparkles, setSparkles] = reactExports.useState([]);
  const sparkleIdRef = reactExports.useRef(0);
  const stateRef = reactExports.useRef({ pos, dir, catState });
  ...
  reactExports.useEffect(() => {
    ...
    timeout = setTimeout(run, 2500 + Math.random() * 2e3);
    return () => clearTimeout(timeout);
  }, []);
  const handleCatClick = reactExports.useCallback(() => {
    playMeow();
    setCatState("tapped");
  ...
  const currentLegs = catState === "walking" ? legAngles[walkFrame] : [0, 0, 0, 0];
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "tap the cat ✦"
          }
        ),
        sparkles.map((sp) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            style: {
              position: "absolute",
          ...
          "button",
          {
            ...
            style: {
              ...
              transform: [
                ...
                isTapped ? "translateY(-10px) scale(1.08)" : "translateY(0) scale(1)"
              ].join(" "),
              transition: isTapped ? "transform 0.12s ease-out" : "transform 0.3s ease",
              userSelect: "none",
              outline: "none"
            },
            "data-ocid": "pet.canvas_target",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(CatSVG, { legs: currentLegs, tailAngle, sitting: isSitting })
          }
        ),
    ...
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "g",
          {
            transform: `translate(18, ${bodyY + bodyHeight - 6}) rotate(${tailAngle}, 0, 0)`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "path",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "-8", cy: "-30", r: "3.5", fill: "#1a1a1a" })
            ]
          }
        ),
        !sitting ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "g",
            {
              transform: `translate(20, ${bodyY + bodyHeight - 6}) rotate(${legs[2]}, 0, 0)`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "-3", y: "0", width: "6", height: "16", rx: "3", fill: "#1a1a1a" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "-4", y: "13", width: "9", height: "5", rx: "2.5", fill: "#1a1a1a" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "g",
            {
              transform: `translate(30, ${bodyY + bodyHeight - 6}) rotate(${legs[3]}, 0, 0)`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "-3", y: "0", width: "6", height: "16", rx: "3", fill: "#1a1a1a" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "-4", y: "13", width: "9", height: "5", rx: "2.5", fill: "#1a1a1a" })
              ]
        ...
        !sitting ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "g",
            {
              transform: `translate(38, ${bodyY + bodyHeight - 6}) rotate(${legs[0]}, 0, 0)`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "-3", y: "0", width: "6", height: "16", rx: "3", fill: "#222" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "-4", y: "13", width: "9", height: "5", rx: "2.5", fill: "#222" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "g",
            {
              transform: `translate(48, ${bodyY + bodyHeight - 6}) rotate(${legs[1]}, 0, 0)`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "-3", y: "0", width: "6", height: "16", rx: "3", fill: "#222" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "-4", y: "13", width: "9", height: "5", rx: "2.5", fill: "#222" })
              ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "38", cy: bodyY - 4, rx: "9", ry: "7", fill: "#1a1a1a" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "44", cy: bodyY - 18, rx: "14", ry: "13", fill: "#1a1a1a" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "polygon",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "39", cy: bodyY - 20, rx: "3", ry: "3.2", fill: "white" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "49", cy: bodyY - 20, rx: "3", ry: "3.2", fill: "white" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "40", cy: bodyY - 20, r: "1.8", fill: "#111" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "50", cy: bodyY - 20, r: "1.8", fill: "#111" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "41", cy: bodyY - 21, r: "0.7", fill: "white" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "51", cy: bodyY - 21, r: "0.7", fill: "white" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "44", cy: bodyY - 13, rx: "2", ry: "1.4", fill: "#e88fa0" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "line",
          {
            x1: "44",
...
function AppContent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PetPage, {}) })
  ] });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(UserSettingsProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(PackStyleProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(InternetIdentityProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppContent, {}) }) }) }) }) });
}
